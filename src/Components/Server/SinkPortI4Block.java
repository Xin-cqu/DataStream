 ...
 */
public class SinkPortI4Block implements SinkPort {
    private SinkI context;
    private File file ;
    private String path;
    private int fileSize;
    private FileOutputStream outputStream;
    public SinkPortI4Block(String path) throws GenericError {
...
//                FileManagementImpl._adapter = adapter;
    ...
    class GetBuffer implements Runnable{

        @Override
        public void run() {
            while (true){
                StreamBuffer theBuffer = null;
                try {
                    theBuffer = context.getBuffer(1,false);
    ...
    public void started(StreamProfile streamPro4sink) throws GenericError {
        ...
        new Thread(new GetBuffer()).start();
    }
